...
files = glob.glob("GwasOutputChr1_2000//*_stats.txt.gz")
...
# fig.show()
fig.write_image("chr" + str(chr) + "gwas_local_plot.jpeg")
fig.write_image("chr" + str(chr) + "gwas_local_plot.svg")
fig.write_image("chr" + str(chr) + "gwas_local_plot.pdf")
