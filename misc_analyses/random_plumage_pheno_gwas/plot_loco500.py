...
files = glob.glob("GwasOutputLoco_500/*_stats.txt.gz")
...
# fig.show()
fig.write_image("chr" + str(chr) + "gwas_loco500_plot.jpeg")
fig.write_image("chr" + str(chr) + "gwas_loco500_plot.svg")
fig.write_image("chr" + str(chr) + "gwas_loco500_plot.pdf")
