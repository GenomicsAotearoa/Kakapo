...
files = glob.glob("GwasOutputLoco_2000/*_stats.txt.gz")
...
# fig.show()
fig.write_image("chr" + str(chr) + "gwas_loco_plot.jpeg")
fig.write_image("chr" + str(chr) + "gwas_loco_plot.svg")
fig.write_image("chr" + str(chr) + "gwas_loco_plot.pdf")
