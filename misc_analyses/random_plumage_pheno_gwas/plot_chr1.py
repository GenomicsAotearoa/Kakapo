...
files = glob.glob("GwasOutputChr1_5/*_stats.txt.gz")
...
# fig.show()
fig.write_image("chr" + str(chr) + "gwas_chr1_plot.jpeg")
fig.write_image("chr" + str(chr) + "gwas_chr1_plot.svg")
fig.write_image("chr" + str(chr) + "gwas_chr1_plot.pdf")
