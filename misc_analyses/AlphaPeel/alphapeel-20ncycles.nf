...
vcf = file("/scale_wlg_nobackup/filesets/nobackup/uoo02695/Kakapo/misc_analyses/AlphaPeel/snps.vcf.gz")
...
process AlphaPeel {
	...
	executor 'slurm'
	publishDir "AlphaPeel_n20_out"
	errorStrategy 'retry'
	maxRetries 5

	tag "${landmark}"

	time { 6.hour + 6.hour * task.attempt }
	memory '105 GB'
	cpus 72
	queue 'large'
