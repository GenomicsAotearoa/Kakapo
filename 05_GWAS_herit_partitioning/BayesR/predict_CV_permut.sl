...
FILES=(./plink_permut/results_0/clo_plink_f_nr_clo_CV10_*.frq)
...
echo ${num}
OUTFILE=./plink_permut/results_0/$(basename ${FILE} .frq)_predicted
echo ${OUTFILE}
BFILE=./plink_permut/plink_0/plink_f_nr_clo_CV10_${num}
#BFILE=./plink/plink_f_nr_clo_CV10
