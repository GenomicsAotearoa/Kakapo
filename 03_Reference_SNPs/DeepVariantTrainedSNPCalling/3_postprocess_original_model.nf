...
//  .fromFilePairs("/scale_wlg_nobackup/filesets/nobackup/uoo02695/Kakapo/03_Reference_SNPs/alignments/*.{cram,cram.crai}", flat: true)
  .fromPath("/scale_wlg_nobackup/filesets/nobackup/uoo02695/Kakapo/03_Reference_SNPs/DeepVariantTrainedSNPCalling/called-original-model/El*.called")
  .set { called_ch }
...
process postprocessOM {
  ...
  memory '6GB'
  cache true
  publishDir './vcfs-original-model', mode: 'copy', overwrite: true
