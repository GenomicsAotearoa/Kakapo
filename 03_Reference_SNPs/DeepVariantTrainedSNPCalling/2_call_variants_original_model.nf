Channel
  .fromFilePairs("/scale_wlg_nobackup/filesets/nobackup/uoo02695/Kakapo/03_Reference_SNPs/DeepVariantTrainedSNPCalling/calling_examples/Elwin*.ds0.with_labels-000{??}-of-00018.examples", size: -1)
  .set { alignments }
...
//  module 'CUDA/10.0.130'
  publishDir "./called-original-model", mode: 'move'
