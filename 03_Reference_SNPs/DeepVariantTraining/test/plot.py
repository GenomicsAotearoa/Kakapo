...
if plot_venn_snps:
	...
	ax1.bar([1,2,3],[723,82462,485],align='center',color='orange',width=0.3)
...
if plot_venn_indels:
	fig = plt.figure(figsize=(4.33070866141732,3.93700787401575))
	ax1 = fig.add_subplot(111)
	ax1.bar([1,2,3],[3912,15226,787],align='center',color='red',width=0.3)
	ax1.ticklabel_format(style='sci', scilimits=(0,0), axis='y')
	ax1.set_xlim(0.5,3.5)
	plt.xticks([1,2,3],('Adela\n3,912','Adela + AdelaB\n15,226','AdelaB\n787'))
