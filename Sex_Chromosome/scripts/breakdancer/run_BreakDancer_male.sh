...
jane_noW=/scale_wlg_nobackup/filesets/nobackup/uoo02695/Kakapo/Sex_Chromosome/alignments_female/jane/jane_sim_noW.sorted.bam
cfg_dir=/scale_wlg_nobackup/filesets/nobackup/uoo02695/Kakapo/Sex_Chromosome/breakdancer/config/
hist_out=/scale_wlg_nobackup/filesets/nobackup/uoo02695/Kakapo/Sex_Chromosome/breakdancer/histograms/
...
for samp in ${workbam}*.sorted.bam
	...
	#bam2cfg.pl -g ${workbam}${base}.sorted.bam ${jane_noW} > ${workbam}${base}.cfg
