...
ref_noW=/scale_wlg_nobackup/filesets/nobackup/uoo02695/Kakapo/Sex_Chromosome/References/kakapo_no_Wchromosome.fna
control=/scale_wlg_nobackup/filesets/nobackup/uoo02695/Kakapo/Sex_Chromosome/alignments_female/jane/jane_sim_noW.sorted.bam
...
for samp in ${workbam}*.sorted.bam
	...
	time delly call -o ${output}${base}.bcf -g ${ref_noW} ${workbam}${base}.sorted.bam ${control}
