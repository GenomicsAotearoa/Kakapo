...
gridss_latest.sif \
--reference ${ref} \
--output ${vcfoutput}males_B06.vcf.gz \
--assembly ${bamoutput}males_B06_gridss.bam \
--threads 8 \
--labels Jane_noW,Morehu,Moss,Ngatapa,Nog,Oraka,Ox,Paddy,Palmersan,Percy,Piripi,Ralph \
